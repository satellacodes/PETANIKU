...
import { useState } from 'react'; // 1. Import useState untuk mengelola state
...
function Navbar() {
  ...
  // 2. Buat state untuk melacak status menu mobile (terbuka/tertutup)
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  // Variabel untuk styling link agar lebih rapi
  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
             {/* Ikon Keranjang untuk mobile, kita letakkan di sini */}
            ...
            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)} // 3. Fungsi untuk toggle menu
      ...
      {/* Panel Menu Mobile */}
      {/* 4. Tampilkan atau sembunyikan menu ini berdasarkan state isMenuOpen */}
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {/* Kita gunakan NavLink agar style aktifnya juga bekerja di mobile */}
